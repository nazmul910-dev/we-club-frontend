...
import ListingOwnerDetailsModal from "./ListingOwnerDetailsModal";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
...
export function AllListingsAdminSection({
  ...
  const openConfirm = (
    type: PendingAction extends null
      ? never
    ...
    switch (pendingAction.type) {
      case "approve":
        return {
          ...
          description:
            "This listing will become active and visible to everyone.",
          confirmText: "Approve",
      ...
      case "reject":
        return {
          ...
          description:
            "The associate will be notified that this listing was rejected.",
          confirmText: "Reject",
              ...
              <tr key={l._id} className="hover:bg-white/2">
                ...
                <td className="px-4 py-3">
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger>
                        <ListingOwnerDetailsModal owner={l.associate_id} listing={l}>
                          <div className="font-medium cursor-pointer text-gold hover:underline">
                            {l.associate_id.fullName}
                          </div>
                        </ListingOwnerDetailsModal>
                      </TooltipTrigger>
                      <TooltipContent>
                        View Listing owner detials
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </td>
