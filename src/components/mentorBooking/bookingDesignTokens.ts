// Shared className fragments matching the warm "Invictus" design system used
// on the member-facing accountability page. Keep these as the single place
// to tweak the palette so every admin booking dialog stays in sync.

export const dialogContentClass =
    "w-[calc(100%-2rem)] max-w-lg overflow-hidden rounded-xl border-[#E9E2D2] bg-[#FBF9F4] p-6 text-[#1C1A16]";
...
export const textareaClass =
    "flex min-h-[110px] w-full resize-none rounded-md border border-[#E9E2D2] bg-white px-3 py-2 text-sm text-[#1C1A16] outline-none placeholder:text-[#B0A996] focus-visible:border-[#C6A34A]";
