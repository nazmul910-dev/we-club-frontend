...
import { Promoter } from "@/lib/features/listings/listingsApi";
...
const PromotersCard = ({ promoter }: { promoter: any }) => {
  ...
  const handleRevoke = (userId: string) => {
    if (confirm("Are you sure you want to revoke this promoter's access?")) {
      // TODO: dispatch revoke thunk when backend endpoint is ready
      console.log("Revoke promoter:", userId);
    }
  };
