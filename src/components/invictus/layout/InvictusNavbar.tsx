...
export default function InvictusNavbar({
  ...
  return (
    <>
      <header className="sticky top-0 z-50 flex h-16 w-full items-center justify-between border-b border-[#EAE4D7] bg-[#FAF8F5]/90 px-4 backdrop-blur-xl md:px-6">
        <div className="flex items-center gap-3">
          <Link href="/invictus" className="group flex items-center gap-2.5">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#F3EBD8]">
              <Crown
                size={20}
                className="text-[#947124] group-hover:scale-110 transition"
              />
            </div>
        ...
        <div className="flex items-center ">
          <DropdownMenu>
            <DropdownMenuTrigger className="outline-none">
              <div className="flex cursor-pointer items-center gap-1 rounded-full border border-[#E0D7C4] bg-white px-3 py-1.5 transition hover:bg-[#F7F2E7]">
                <Globe size={13} className="text-[#947124]" />

                <span className="font-montserrat text-[10px] font-bold text-[#6B6358]">
                  FR
                </span>

                <ChevronDown size={12} className="text-[#8C8273]" />
              </div>
            </DropdownMenuTrigger>

            <DropdownMenuContent
              align="end"
              className="w-40 rounded-2xl border border-[#EAE4D7] bg-[#FAF8F5] p-2 shadow-2xl"
            >
              <DropdownMenuItem className="rounded-xl font-montserrat text-xs hover:bg-[#F3EBD8]">
                🇬🇧 English
              </DropdownMenuItem>
        ...
        <DialogContent className="max-w-md rounded-2xl border border-[#DECDB0] bg-[#FAF8F5]">
          ...
          <DialogFooter>
            ...
            <button
              ...
              className="rounded-xl bg-[#947124] px-5 py-2 text-sm text-white"
            >
              Yes Switch
            </button>
          </DialogFooter>
        ...
        <DialogContent className="max-w-md rounded-2xl border border-[#EAE4D7] bg-[#FAF8F5]">
          ...
          <DialogFooter>
            ...
            <button
              ...
              className="rounded-xl bg-[#947124] px-5 py-2 text-white"
            >
              Yes Sign Out
            </button>
          </DialogFooter>
