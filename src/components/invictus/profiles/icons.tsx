export const LinkedInIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor">
    <path d="M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM.24 8.24h4.5V23H.24V8.24zM8.5 8.24h4.32v2.01h.06c.6-1.14 2.07-2.34 4.26-2.34 4.56 0 5.4 3 5.4 6.9V23h-4.5v-6.9c0-1.65-.03-3.78-2.3-3.78-2.3 0-2.66 1.8-2.66 3.66V23H8.5V8.24z" />
  </svg>
);
...
export const WebsiteIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 0a12 12 0 100 24 12 12 0 000-24zm7.94 10H16.9a15.7 15.7 0 00-1.38-6.06A10.02 10.02 0 0119.94 10zM12 2.05c.86 1.1 2.28 3.4 2.6 7.95H9.4c.32-4.55 1.74-6.85 2.6-7.95zM9.4 12h5.2c-.32 4.55-1.74 6.85-2.6 7.95-.86-1.1-2.28-3.4-2.6-7.95zM8.48 3.94A15.7 15.7 0 007.1 10H4.06a10.02 10.02 0 014.42-6.06zM4.06 12H7.1a15.7 15.7 0 001.38 6.06A10.02 10.02 0 014.06 12zm11.46 6.06A15.7 15.7 0 0016.9 12h3.04a10.02 10.02 0 01-4.42 6.06z" />
  </svg>
);
