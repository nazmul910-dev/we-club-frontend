    ...
    <div className="space-y-4">
      {data.map((item: any, index: number) => (
        ...
        >
          ...
          <strong className="font-playfair">{item.score || item.value}</strong>
        </div>
      ))}
    </div>
  );
      ...
      <div className="rounded-2xl bg-[#FAF6EE] p-8 grid md:grid-cols-2 gap-10">
        <div>
          <div className="flex gap-3 items-center mb-5">
            ...
            <h3 className="font-playfair text-xl">INVICTUS Challenge</h3>
          </div>
        ...
        <div>
          <div className="flex gap-3 items-center mb-5">
            ...
            <h3 className="font-playfair text-xl">World Elite Referrals</h3>
          </div>
