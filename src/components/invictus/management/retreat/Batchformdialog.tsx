...
import { dialogContentClass, dialogDescriptionClass, dialogTitleClass, inputClass, outlineButtonClass, primaryButtonClass, sectionLabelClass, textareaClass } from "@/app/invictus/management/retreat/Retreatdesigntokens";
import { createRetreatBatch, selectRetreatStatus, updateRetreatBatch } from "@/lib/features/retreat/retreatSlice";
...
export default function BatchFormDialog({
    ...
    useEffect(() => {
        if (open) {
            setForm(
                batch ? toFormState(batch) : emptyForm(defaultLocationId),
            );
        }
