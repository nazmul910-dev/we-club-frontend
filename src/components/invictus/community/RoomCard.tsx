...
export function RoomCard({
    ...
    return (
        <a
            ...
            className={`group relative  block animate-rise overflow-hidden border border-[#ecdfb8] bg-gradient-to-br from-cream to-cream-deep px-6 pb-7 pt-8 text-center transition-all duration-[450ms] ease-out rounded-xl bg-[#FAF6EE] shadow-2xs ${
                disabled
        ...
        >
            ...
            {onRequest && (
                <button
                    ...
                    className="absolute right-3 cursor-pointer top-3 rounded-full p-1.5 text-ink-soft transition hover:bg-[#F3E9D2] hover:text-gold-deep"
                >
                    <Send size={18} />
                </button>
            )}
