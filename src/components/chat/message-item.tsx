...
export default function MessageItem({
    ...
    return (
        ...
        >
            <div
                className={`relative flex items-center justify-center gap-3 max-w-[70%] ${me ? "flex-row-reverse" : ""}`}
            >
                {/* Avatar */}
                ...
                >
                    {/* Name + time */}
                    <div
                        className={`flex gap-2 items-center mb-1 ${me ? "flex-row-reverse" : ""}`}
                    >
              ...
              `}
                    ...
                    <div
                        className={`flex items-center ${!me ? "flex-row-reverse" : ""}`}
                    >
                        {" "}
    ...
    ${
        isDeleted
            ? "italic text-zinc-500 bg-black-900 "
            : me
              ? "bg-zinc-200 text-black rounded-tr-sm"
