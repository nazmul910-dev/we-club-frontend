...
export default function NetworkListItem({ data }: Props) {
    ...
    <div className="flex items-center justify-between border border-[#5c4518] bg-[#090909] rounded-xl p-5 hover:border-[#c9a227] transition">
      <div className="flex items-center gap-5">
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">{user?.brokerage}</p>
        </div>
      </div>
      ...
      <div className="hidden md:block">
        ...
        <p className="text-white text-sm mt-1">{latestListing.listing_title}</p>
      </div>
      ...
      <div className="text-right">
        ...
        <div className="flex gap-2 mt-3 justify-end">
          ...
          <a
            ...
            className="w-8 h-8 rounded-full border border-[#5c4518] flex items-center justify-center text-gray-400"
          >
            <Mail size={14} />
          </a>
