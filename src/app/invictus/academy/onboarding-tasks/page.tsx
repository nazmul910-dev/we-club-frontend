...
function OnboardingTasksContent() {
    ...
    const [selectedTask, setSelectedTask] =
        useState<AdminOnboardingTask | null>(null);
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
                <div>
                    ...
                    <p className="mt-2 max-w-xl text-sm text-[#8A8175]">
                        These are the checklist items shown on the World Élite
                        Associates &quot;Your First Week&quot; page. Each
                        published task awards points the moment a member
                        completes it, and feeds directly into their leaderboard
                        points total.
                    </p>
                </div>
