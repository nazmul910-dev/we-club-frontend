...
import {
    ...
    LeaderboardStatus,
    LeaderboardType,
} from "@/lib/features/leaderboardAdmin/leaderboardAdminTypes";
import {
    activateLeaderboard,
    createLeaderboard,
    fetchLeaderboards,
    finalizeLeaderboard,
} from "@/lib/features/leaderboardAdmin/leaderboardAdminSlice";
...
const STATUS_STYLES: Record<LeaderboardStatus, string> = {
    ...
    finalized: "bg-gold/10 text-gold",
...
export default function LeaderboardAdminPage() {
    ...
    const { leaderboards, meta, loading, actionLoading, error } =
    ...
    return (
        <PageContainer variant="invictus">
            ...
            {createOpen && (
                <Card className="mt-6 border px-5 py-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) =>
                                    setForm((f) => ({
                                        ...f,
                                        type: e.target.value as LeaderboardType,
                                    }))
                                }
                            >
